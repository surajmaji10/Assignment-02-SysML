...
optimizer = optim.Adam(list(convolution_layer_1.parameters()) + \
                       list(convolution_layer_2.parameters()) + \
                       list(fully_connected_layer_1.parameters()) + \
                       list(fully_connected_layer_2.parameters()) + \
                       list(fully_connected_layer_3.parameters())   , lr=0.005)  
...
plt.subplot(1, 2, 1)  
plt.plot(range(num_epochs), training_loss, label="Training Loss Seen")  
plt.xlabel("Epochs")  
plt.ylabel("Loss")  
plt.legend()  

plt.subplot(1, 2, 2)  
plt.plot(range(num_epochs), training_accuracy, label="Training Accuracy Seen")  
plt.xlabel("Epochs")  
plt.ylabel("Accuracy")  
plt.legend()  
plt.show()